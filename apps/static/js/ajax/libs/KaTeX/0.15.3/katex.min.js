!function (e, t) {
    ...
    return function () {
        ...
        var I = [[1, 1, 1], [2, 1, 1], [3, 1, 1], [4, 2, 1], [5, 2, 1], [6, 3, 1], [7, 4, 2], [8, 6, 3], [9, 7, 6], [10, 8, 7], [11, 10, 9]],
            R = [.5, .6, .7, .8, .9, 1, 1.2, 1.44, 1.728, 2.074, 2.488], O = function (e, t) {
        ...
        var oe = "math", se = "text", le = "main", he = "ams", me = "accent-token", ce = "bin", ue = "close",
        ...
        var lt = function (e) {
            ...
            }, mt = Ke.makeSpan, ct = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
            ...
            pt = {display: x.DISPLAY, text: x.TEXT, script: x.SCRIPT, scriptscript: x.SCRIPTSCRIPT}, dt = {
                ...
                var c = mt([n[0] || "leftmost"], [], t), u = mt([n[1] || "rightmost"], [], t), p = "root" === r;
        ...
        function Ot(e, t, r, n, a) {
            ...
            var h = new Tt.MathNode("semantics", [i, s]), m = new Tt.MathNode("math", [h]);
        ...
        var Ht = function (e) {
            ...
            if ("html" === r.output) {
                ...
                var o = Ot(e, t, a, r.displayMode, !1), s = St(e, a);
            ...
            var r = function () {
                ...
                var u, p, d, f = [], g = Pt[n], v = g[0], b = g[1], y = g[2], x = y / 1e3, w = v.length;
        ...
        ot({
            ...
            mathmlBuilder: function (e, t) {
                var r = Vt(e.label), n = new Tt.MathNode("munder", [Rt(e.base, t), r]);
        ...
        var Qt = function (e, t) {
            ...
            var r = Nt(e.body, t.withColor(e.color)), n = new Tt.MathNode("mstyle", r);
        ...
        ot({
            ...
            handler: function (e) {
                ...
                return o && h.unshift(o), "\\edef" !== r && "\\xdef" !== r || (h = t.gullet.expandTokens(h)).reverse(), t.gullet.macros.set(i, {
                    ...
                    numArgs: s,
                    delimiters: l
                }, r === tr[r]), {type: "internal", mode: t.mode}
            }
        }), ot({
            type: "internal",
            names: ["\\let", "\\\\globallet"],
            props: {numArgs: 0, allowedInText: !0, primitive: !0},
            handler: function (e) {
                var t = e.parser, r = e.funcName, n = rr(t.gullet.popToken());
            ...
            props: {numArgs: 0, allowedInText: !0, primitive: !0},
            handler: function (e) {
                var t = e.parser, r = e.funcName, n = rr(t.gullet.popToken()), a = t.gullet.popToken(),
                    i = t.gullet.popToken();
        ...
        var ar = function (e, t, r) {
                ...
                }(e, t, a, n), s = ir(Ke.makeSpan(["delimsizing", "size" + t], [o], n), x.TEXT, n, i);
                ...
                return o.height = t, o.style.height = V(t), o.style.width = V(n), {type: "elem", elem: o}
            }, mr = {type: "kern", size: -.008}, cr = ["|", "\\lvert", "\\rvert", "\\vert"],
            ur = ["\\|", "\\lVert", "\\rVert", "\\Vert"], pr = function (e, t, r, n, a, i) {
                var o, s, h, m;
                o = h = m = e, s = null;
                var c = "Size1-Regular";
                ...
                var u = ar(o, c, a), p = u.height + u.depth, d = ar(h, c, a), f = d.height + d.depth, g = ar(m, c, a),
                    v = g.height + g.depth, b = 0, y = 1;
                if (null !== s) {
                    var w = ar(s, c, a);
                    b = w.height + w.depth, y = 2
                }
                var k = p + v + b, S = k + Math.max(0, Math.ceil((t - k) / (y * f))) * y * f,
            ...
            br = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"], yr = [0, 1.2, 1.8, 2.4, 3],
            xr = [{type: "small", style: x.SCRIPTSCRIPT}, {type: "small", style: x.SCRIPT}, {
                type: "small",
                style: x.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {type: "large", size: 4}],
            wr = [{type: "small", style: x.SCRIPTSCRIPT}, {type: "small", style: x.SCRIPT}, {
                type: "small",
                style: x.TEXT
            }, {type: "stack"}], kr = [{type: "small", style: x.SCRIPTSCRIPT}, {type: "small", style: x.SCRIPT}, {
                type: "small",
                style: x.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {
                type: "large",
                size: 4
            }, {type: "stack"}], Sr = function (e) {
                ...
                for (var a = Math.min(2, 3 - n.style.size); a < r.length && "stack" !== r[a].type; a++) {
                    var i = ar(e, Sr(r[a]), "math"), o = i.height + i.depth;
                ...
                return "small" === s.type ? function (e, t, r, n, a, i) {
                    var o = Ke.makeSymbol(e, "Main-Regular", a, n), s = ir(o, t, n, i);
                    return r && or(s, n, t), s
                }(e, s.style, r, n, a, i) : "large" === s.type ? sr(e, s.size, r, n, a, i) : pr(e, t, r, n, a, i)
            }, Ar = {
                sqrtImage: function (e, t) {
                    var r, n, a = t.havingBaseSizing(), i = Mr("\\surd", e * a.sizeMultiplier, kr, a), o = a.sizeMultiplier,
                ...
                }, sizeToMaxHeight: yr, customSizedDelim: zr, leftRightDelim: function (e, t, r, n, a, i) {
        ...
        var Nr = function (e, t) {
            var r, n, a, i = Ke.wrapFragment(wt(e.body, t), t), o = e.label.substr(1), s = t.sizeMultiplier, h = 0,
            ...
            if ("sout" === o) (r = Ke.makeSpan(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / s, h = -.5 * t.fontMetrics().xHeight; else if ("phase" === o) {
                var c = F({number: .6, unit: "pt"}, t), u = F({number: .35, unit: "ex"}, t);
        ...
        function Gr(e, t, r) {
            var a = t.hskipBeforeAndAfter, i = t.addJot, o = t.cols, s = t.arraystretch, l = t.colSeparationType,
                h = t.autoTag, m = t.singleRow, c = t.emptySingleRow, u = t.maxNumCols, p = t.leqno;
        ...
        var Yr = function (e, t) {
            ...
            var d = "CD" === e.colSeparationType ? F({number: 3, unit: "ex"}, t) : 12 * u, f = 3 * u,
                g = e.arraystretch * d, v = .7 * g, b = .3 * g, y = 0;

            function w(e) {
                for (var t = 0; t < e.length; ++t) t > 0 && (y += .25), m.push({pos: y, isDashed: e[t]})
            }
            ...
            var C, q, N = y / 2 + t.fontMetrics().axisHeight, I = e.cols || [], R = [], O = [];
            if (e.tags && e.tags.some((function (e) {
                return e
            }))) for (r = 0; r < i; ++r) {
                var H = h[r], E = H.pos - N, L = e.tags[r], D = void 0;
            ...
            for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
                for (var P = I[q] || {}, G = !0; "separator" === P.type;) {
                    ...
                    var U = "|" === P.separator ? "solid" : "dashed", Y = Ke.makeSpan(["vertical-separator"], [], t);
        ...
        }, Xr = {c: "center ", l: "left ", r: "right "}, Wr = function (e, t) {
        ...
        Or({
            ...
            }, htmlBuilder: Yr, mathmlBuilder: Wr
        }), Or({
            type: "array",
            ...
            handler: function (e) {
                ...
                var o = Gr(e.parser, a, Ur(e.envName)), s = Math.max.apply(Math, [0].concat(o.body.map((function (e) {
                    return e.length
                }))));
            ...
            type: "array", names: ["smallmatrix"], props: {numArgs: 0}, handler: function (e) {
                var t = Gr(e.parser, {arraystretch: .5}, "script");
                ...
                return Fr(e), function (e) {
                    ...
                    for (var a, i, o = [], s = [o], l = 0; l < t.length; l++) {
                        for (var h = t[l], m = {
                            ...
                            o.push(m);
                            var u = Yt(h[c += 1]).text, p = new Array(2);
        ...
        ot({
            ...
            handler: function (e, t) {
                ...
                if ("\\begin" === a) {
                    ...
                    var l = jr[o], h = r.parseArguments("\\begin{" + o + "}", l), m = h.args, c = h.optArgs,
        ...
        ot({
            ...
            handler: function (e, t) {
                var r, n = e.parser, a = t[4], i = t[5], o = lt(t[0]),
                    ...
                    h = "atom" === l.type && "close" === l.family ? sn(l.text) : null, m = Ut(t[2], "size"), c = null;
        ...
        var cn = function (e, t, r, n, a, i, o) {
            ...
            if (s.size === x.DISPLAY.size && a.symbol && !l.contains(un, a.name) && (h = !0), a.symbol) {
                ...
                if ("\\oiint" !== a.name && "\\oiiint" !== a.name || (c = a.name.substr(1), a.name = "oiint" === c ? "\\iint" : "\\iiint"), o = Ke.makeSymbol(a.name, m, "math", t, ["mop", "op-symbol", h ? "large-op" : "small-op"]), c.length > 0) {
                    var u = o.italic, p = Ke.staticSvg(c + "Size" + (h ? "2" : "1"), t);
                    o = Ke.makeVList({
                        positionType: "individualShift",
            ...
            var r;
            if (e.symbol) r = new zt("mo", [Bt(e.name, e.mode)]), l.contains(un, e.name) && r.setAttribute("largeop", "false"); else if (e.body) r = new zt("mo", Nt(e.body, t)); else {
        ...
        ot({
            ...
            mathmlBuilder: function (e, t) {
                var r = Nt(ht(e.body), t), n = new Tt.MathNode("mphantom", r), a = new Tt.MathNode("mpadded", [n]);
            ...
            htmlBuilder: function (e, t) {
                var r = Ke.makeSpan(["mord", "rule"], [], t), n = F(e.width, t), a = F(e.height, t),
            ...
            mathmlBuilder: function (e, t) {
                var r = F(e.width, t), n = F(e.height, t), a = e.shift ? F(e.shift, t) : 0,
        ...
        ot({
            type: "sizing", names: yn, props: {numArgs: 0, allowedInText: !0}, handler: function (e, t) {
                ...
                var r = t.havingSize(e.size), n = Nt(e.body, r), a = new Tt.MathNode("mstyle", n);
            ...
            type: "sqrt", names: ["\\sqrt"], props: {numArgs: 1, numOptionalArgs: 1}, handler: function (e, t, r) {
                ...
                var i = n + a / 4, o = r.height + r.depth + i + n, s = Ar.sqrtImage(o, t), l = s.span, h = s.ruleWidth,
        ...
        ot({
            ...
            mathmlBuilder: function (e, t) {
                var r = xn[e.style], n = t.havingStyle(r), a = Nt(e.body, n), i = new Tt.MathNode("mstyle", a), o = {
                    display: ["0", "true"],
                    text: ["0", "false"],
                    script: ["1", "false"],
        ...
        st({
            type: "supsub", htmlBuilder: function (e, t) {
                var r = wn(e, t);
                if (r) return r(e, t);
                var n, a, i, o = e.base, s = e.sup, h = e.sub, m = wt(o, t), c = t.fontMetrics(), u = 0, p = 0,
                ...
                var v, b = t.sizeMultiplier, y = V(.5 / c.ptPerEm / b), w = null;
                if (a) {
        ...
        st({
            type: "mathord", htmlBuilder: function (e, t) {
                ...
                var r = new Tt.MathNode("mi", [Bt(e.text, e.mode, t)]), n = qt(e, t) || "italic";
            ...
            type: "textord", htmlBuilder: function (e, t) {
                ...
                var r, n = Bt(e.text, e.mode, t), a = qt(e, t) || "normal";
        ...
        ot({
            ...
            type: "verb", names: ["\\verb"], props: {numArgs: 0, allowedInText: !0}, handler: function (e, t, r) {
                ...
                var r = new Tt.TextNode(qn(e)), n = new Tt.MathNode("mtext", [r]);
                return n.setAttribute("mathvariant", "monospace"), n
            }
        });
        var qn = function (e) {
            return e.body.replace(/ /g, e.star ? "\u2423" : "\xa0")
        }, Nn = nt, In = new RegExp("[\u0300-\u036f]+$"), Rn = function () {
            function e(e, t) {
        ...
        var Vn = {"^": !0, _: !0, "\\limits": !0, "\\nolimits": !0}, Gn = function () {
            ...
            return t.expect = function (e, t) {
                ...
                if (o && ("i" === (t = t.substring(0, o.index)) ? t = "\u0131" : "j" === t && (t = "\u0237")), ae[this.mode][t]) {
                    ...
                    var s, l = ae[this.mode][t].group, h = Lr.range(e);
            ...
            __renderToHTMLTree: function (e, t) {
                ...
                try {
                    return function (e, t, r) {
                        var n = St(e, Ht(r)), a = Ke.makeSpan(["katex"], [n]);
                        return Et(a, r)
                    }(Wn(e, r), 0, r)
                } catch (t) {
                    return jn(t, e, r)
