...
_hsq.push(['setPortalId', 2977146]);
_hsq.push(['trackPageView']);
_hsq.push(['setLegacy', false]);
_hsq.push(['addCookieDomain', '.hs-sites.com']);
_hsq.push(['addCookieDomain', '.accredible.com']);
...
_hsq.push(['addCookieDomain', '.badge.design']);
_hsq.push(['enableAutomaticLinker', true]);
_hsq.push(['embedHubSpotScript', 'https://js-na1.hs-scripts.com/2977146.js', 'hs-script-loader']);
...
/** _anon_wrapper_ **/ (function () {
    ...
    hstc.utils.deparam = function (t, e) {
        var i = {}, n = {true: !0, false: !1, null: null};
        ...
        hstc.utils.each(t.split("+").join(" ").split("&"), (function (t, r) {
            var s, o = r.split("="), c = hstc.utils.decodeParam(o[0]), a = i, h = 0, u = c.split("]["),
                l = u.length - 1;
    ...
    hstc.utils.updateQueryStringParameter = function (t, e, i) {
        ...
        if (i) {
            var r = t.indexOf("#"), s = t.indexOf("?"), o = -1 !== s && (-1 === r || s < r) ? "&" : "?",
                c = t.split("#");
            t = c[0] + o + e + "=" + i;
            c[1] && (t += "#" + c[1]);
            return t
    ...
    hstc.utils.logError = function (t, e) {
        e = e || "";
        var i = {w: hstc.utils.utcnow(), m: t.message || t.toString ? t.toString() : "-", j: hstc.JS_VERSION};
        t.name && (i.n = t.name);
    ...
    (hstc = hstc || {}).browser = function (t) {
        var e = (t = t || new hstc.global.Context).getNavigator(), i = e.userAgent.toLowerCase(), n = {
            ...
            dataBrowser: [{string: e.userAgent, subString: "Chrome", identity: "Chrome"}, {
                string: e.userAgent,
                subString: "OmniWeb",
                ...
                identity: "Mozilla",
                versionSearch: "rv"
            }, {string: e.userAgent, subString: "Mozilla", identity: "Netscape", versionSearch: "Mozilla"}],
            dataOS: [{string: e.platform, subString: "Win", identity: "Windows"}, {
                string: e.platform,
                subString: "Mac",
                identity: "Mac"
    ...
    hstc.tracking.Tracker.prototype.trackConversion = function (t, e) {
        ...
        var i = hstc.utils.mergeObject(t, {k: 3, n: hstc.utils.safeString(t.id), m: hstc.utils.safeString(t.value)});
        this._loadImage(i)
    };
    ...
    hstc.tracking.Tracker.prototype.trackClick = function (t, e, i) {
        var n = this, r = {
            selector: t, eventId: e, opts: i = i || {}, handler: function (t) {
                try {
    ...
    hstc.tracking.Tracker.prototype.trackFeedbackView = function (t) {
        t = t || {};
        var e = {k: 26, st: hstc.utils.safeString(t.surveyType), si: hstc.utils.safeString(t.surveyId)};
        this._loadImage(e)
    };
    hstc.tracking.Tracker.prototype.trackCtaView = function (t, e) {
        var i = {k: 12, aij: '["' + hstc.utils.safeString(t) + '","' + hstc.utils.safeString(e) + '"]', rfc: 8};
        this._loadImage(i)
    };
                ...
                if (i.__hstc) {
                    ...
                    hstc.utils.each(this.cookie.getDomains(), (function (e, i) {
                        if (hstc.utils.hashString(i) == o.domain) {
                            if (n.utk && n.utk.visitor !== o.visitor) n.identify({visitor: o.visitor}, !0); else if (t.recovered) {
    ...
    hstc.tracking.Tracker.prototype._extractUtkOverride = function (t) {
        ...
        if (e) {
            var i = this.utk && this.utk.visitor == e, n = t.visitor == e,
    ...
    hstc.tracking.Tracker.prototype.initEventVisualizerScript = function () {
        const t = "eventVisualizerIsLocal", e = "hubspotEventVisualizeMode", i = "true",
            n = this.hasTrackingGate("WA:FeatureEventVisualizer");
        try {
            if (n) {
                const n = localStorage.getItem(e) === i, r = document.createElement("script"),
                    s = this.context.getReferrer();
                if (/^https:\/\/(app|local)(-[a-z]{2}[0-9]{1})?\.hubspot(qa)?\.com/.test(s) || n) {
                    const e = localStorage.getItem(t) === i, n = e ? "local" : "app",
                        s = /^https:\/\/js(-?[a-z0-9]*)\.([a-z0-9-]+)\./i, o = thisScriptUrl.match(s);
                    if (o) {
                        const t = e ? "" : o[1], i = "hs-analytics" === o[2] ? "hubspot" : "hubspotqa";
    ...
    !function (t) {
        var e, i, n, r, s, o, c, a, h, u, l, p, g, f, d, k, m, y = "sizzle" + -new Date, v = t.document, C = 0, _ = 0,
            T = rt(), w = rt(), x = rt(), S = !1, b = function (t, e) {
                if (t === e) {
                    S = !0;
                    return 0
                }
                return 0
            }, E = "undefined", I = 1 << 31, D = {}.hasOwnProperty, L = [], N = L.pop, A = L.push, O = L.push, P = L.slice,
            ...
            M = "[\\x20\\t\\r\\n\\f]", q = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", F = q.replace("w", "w#"),
            j = "\\[" + M + "*(" + q + ")" + M + "*(?:([*^$|!~]?=)" + M + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + F + ")|)|)" + M + "*\\]",
            H = ":(" + q + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + j.replace(3, 8) + ")*)|.*)\\)|)",
            B = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$", "g"),
            $ = new RegExp("^" + M + "*," + M + "*"), V = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"),
            K = new RegExp(M + "*[+~]"), W = new RegExp("=" + M + "*([^\\]'\"]*)" + M + "*\\]", "g"), G = new RegExp(H),
            z = new RegExp("^" + F + "$"), Y = {
                ID: new RegExp("^#(" + q + ")"),
                CLASS: new RegExp("^\\.(" + q + ")"),
            ...
            }, X = /^[^{]+\{\s*\[native \w/, Q = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
            J = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, tt = /'|\\/g,
        ...
        (r = nt.selectors = {
            ...
            preFilter: {
                ATTR: function (t) {
                    ...
                    if (t[3] && void 0 !== t[4]) t[2] = t[4]; else if (i && G.test(i) && (e = gt(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length)) {
                        t[0] = t[0].slice(0, e);
                        t[2] = i.slice(0, e)
                    }
                    return t.slice(0, 3)
            ...
            filter: {
                TAG: function (t) {
                    ...
                    return 1 === n && 0 === r ? function (t) {
                        ...
                        var h, u, l, p, g, f, d = s !== o ? "nextSibling" : "previousSibling", k = e.parentNode,
                            m = c && e.nodeName.toLowerCase(), v = !a && !c;
                        if (k) {
                            if (s) {
                                for (; d;) {
                                    l = e;
                            ...
                            if (o && v) {
                                ...
                                p = h[0] === C && h[2];
                                l = g && k.childNodes[g];
                                for (; l = ++g && l && l[d] || (p = g = 0) || f.pop();) if (1 === l.nodeType && ++p && l === e) {
                                    u[t] = [C, g, p];
                                    break
                                }
                            } else if (v && (h = (e[y] || (e[y] = {}))[t]) && h[0] === C) p = h[1]; else for (; l = ++g && l && l[d] || (p = g = 0) || f.pop();) if ((c ? l.nodeName.toLowerCase() === m : 1 === l.nodeType) && ++p) {
                                v && ((l[y] || (l[y] = {}))[t] = [C, p]);
                                if (l === e) break
                            }
        ...
        function yt(t, e, i, n, r, s) {
            ...
            return st((function (s, o, c, a) {
                var h, u, l, p = [], g = [], f = o.length, d = s || _t(e || "*", c.nodeType ? [c] : c, []),
                    k = !t || !s && e ? d : mt(d, p, t, c, a), m = i ? r || (s ? t : f || n) ? [] : o : k;
                i && i(k, m, c, a);
                if (n) {
                    h = mt(m, g);
                    n(h, [], c, a);
        ...
        function vt(t) {
            ...
            }]; h < s; h++) if (i = r.relative[t[h].type]) p = [dt(kt(p), i)]; else {
                if ((i = r.filter[t[h].type].apply(null, t[h].matches))[y]) {
                    n = ++h;
                    for (; n < s && !r.relative[t[n].type]; n++) ;
                    return yt(h > 1 && kt(p), h > 1 && ft(t.slice(0, h - 1).concat({value: " " === t[h - 2].type ? "*" : ""})).replace(B, "$1"), i, h < n && vt(t.slice(h, n)), n < s && vt(t = t.slice(n)), n < s && ft(t))
                }
                p.push(i)
            }
            return kt(p)
        ...
        function Ct(t, e) {
            var i = 0, s = e.length > 0, o = t.length > 0, c = function (c, h, u, p, g) {
                var f, d, k, m = [], y = 0, v = "0", _ = c && [], T = null != g, w = a,
                    x = c || o && r.find.TAG("*", g && h.parentNode || h), S = C += null == w ? 1 : Math.random() || .1,
                    b = x.length;
                if (T) {
                    a = h !== l && h;
                    n = i
